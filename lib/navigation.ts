...
type NavLink = { pageId: PageId; label: string; anchor?: string };
...
const navContent: Record<Locale, NavCopy> = {
  de: {
    ...
    navLinks: [
      ...
      { pageId: 'home', label: 'Leistungen', anchor: '#leistungen' },
  ...
  en: {
    ...
    navLinks: [
      ...
      { pageId: 'home', label: 'Services', anchor: '#leistungen' },
  ...
  pl: {
    ...
    navLinks: [
      ...
      { pageId: 'home', label: 'Usługi', anchor: '#leistungen' },
